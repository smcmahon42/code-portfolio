angular.module('technicalMileStones',[])
.directive('technicalMileStones', function($rootScope, $timeout, TrackImgSvc) {
	return {
		replace: true,
		restrict: 'E',
		templateUrl: 'app/global_partials/technicalMileStones.html',
